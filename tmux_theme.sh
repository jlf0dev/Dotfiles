...
# set -g status-utf8 "on"  No longer needed in this version of tmux
...
set -g status-left "#[fg=colour236,bg=colour110] #S #[fg=colour110,bg=colour238,nobold,nounderscore,noitalics]"
set -g status-right "#[fg=colour237,bg=colour238,nobold,nounderscore,noitalics]#[fg=colour249,bg=colour237] %Y-%m-%d  %H:%M #[fg=colour110,bg=colour237,nobold,nounderscore,noitalics]#[fg=colour236,bg=colour110] #h "
